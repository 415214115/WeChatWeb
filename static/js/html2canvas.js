...
! function(A, e) {
		...
		function e(e) {
			return function(A) {
				return function(e) {
					...
					for (; o;) try {
						if (B = 1, n && (s = 2 & e[0] ? n.return : e[0] ? n.throw || ((s = n.return) && s.call(n), 0) : n.next) && !(
	...
	for (var T = function(A) {
				...
				for (var r = [], B = -1, n = ""; ++B < t;) {
					var s = A[B];
					s <= 65535 ? r.push(s) : (s -= 65536, r.push(55296 + (s >> 10), s % 1024 + 56320)), (B + 1 === t || 16384 < r.length) &&
	...
	function i(A, e, t, r, B, n) {
		this.initialValue = A, this.errorValue = e, this.highStart = t, this.highValueIndex = r, this.index = B, this.data =
			n
	}
	...
	function w(A, e, t, r, B) {
		...
		if (-1 !== [M, S].indexOf(i) && (c === D || -1 !== [O, f].indexOf(c) && e[1 + o] === D) || -1 !== [O, f].indexOf(i) &&
	...
	function u(t, A) {
		...
		var e = function(A, B) {
				...
				return A.forEach(function(A, e) {
					var t = q.get(A);
					if (50 < t ? (o.push(!0), t -= 50) : o.push(!1), -1 !== ["normal", "auto", "loose"].indexOf(B) && -1 !== [8208,
							8211, 12316, 12448
						].indexOf(A)) return s.push(e), n.push(16);
					if (4 !== t && 11 !== t) return s.push(e), 31 === t ? n.push("strict" === B ? L : X) : t === W ? n.push(_) : 29 ===
						t ? n.push(_) : 43 === t ? 131072 <= A && A <= 196605 || 196608 <= A && A <= 262141 ? n.push(X) : n.push(_) :
						void n.push(t);
	...
	var a, U, E, F, h, H = 10,
		...
		q = (a = function(A) {
			...
			for (e = 0; e < o; e += 4) t = Q[A.charCodeAt(e)], r = Q[A.charCodeAt(e + 1)], B = Q[A.charCodeAt(e + 2)], n = Q[A
				.charCodeAt(e + 3)], c[i++] = t << 2 | r >> 4, c[i++] = (15 & r) << 4 | B >> 2, c[i++] = (3 & B) << 6 | 63 & n;
			return a
		}(
	...
	var CA = {
		...
		MA = (yA.prototype.write = function(A) {
			...
			for (var e = "", t = 0;;) {
				...
				if (92 === r) {
					var B = this._value[t + 1]; - 1 !== B && void 0 !== B && (10 === B ? (e += this.consumeStringSlice(t), t = -1,
						this._value.shift()) : uA(r, B) && (e += this.consumeStringSlice(t), e += l(this.consumeEscapedCodePoint()),
						t = -1))
				}
				t++
			}
	...
	function Ie(A) {
		...
		return WA(A).forEach(function(A, e) {
			if (0 === e) {
				var t = A[0];
				if (t.type === sA.IDENT_TOKEN && -1 !== ["top", "left", "right", "bottom"].indexOf(t.value)) return void(B = Ae(
					A));
	...
	var me = {
			...
			get SUPPORT_FOREIGNOBJECT_DRAWING() {
				var A = "function" == typeof Array.from && "function" == typeof window.fetch ? function(r) {
					...
					return n.fillStyle = "red", n.fillRect(0, 0, B, B), Oe(t).then(function(A) {
						...
						return t.style.backgroundImage = "url(" + s + ")", t.style.height = "100px", Te(e) ? Oe(Le(B, B, 0, 0, t)) :
							Promise.reject(!1)
					}).then(function(A) {
		...
		De = (Se.prototype.debug = function() {
			for (var A = [], e = 0; e < arguments.length; e++) A[e] = arguments[e];
			"undefined" != typeof window && window.console && "function" == typeof console.debug ? console.debug.apply(console,
				[this.id, this.getTime() + "ms"].concat(A)) : this.info.apply(this, A)
			...
			for (var A = [], e = 0; e < arguments.length; e++) A[e] = arguments[e];
			"undefined" != typeof window && window.console && "function" == typeof console.info && console.info.apply(console,
				[this.id, this.getTime() + "ms"].concat(A))
		}, Se.prototype.error = function() {
			for (var A = [], e = 0; e < arguments.length; e++) A[e] = arguments[e];
			"undefined" != typeof window && window.console && "function" == typeof console.error ? console.error.apply(console,
				[this.id, this.getTime() + "ms"].concat(A)) : this.info.apply(this, A)
		}, Se.instances = {}, Se);
	...
	var ye = (_e.prototype.addImage = function(A) {
		...
		return B(this, void 0, void 0, function() {
			...
			return b(this, function(A) {
				switch (A.label) {
					case 0:
						return e = be.isSameOrigin(s), r = !ke(s) && !0 === this._options.useCORS && ve.SUPPORT_CORS_IMAGES && !e,
							t = !ke(s) && !e && "string" == typeof this._options.proxy && ve.SUPPORT_CORS_XHR && !r, e || !1 !== this
							._options.allowTaint || ke(s) || t || r ? (B = s, t ? [4, this.proxy(B)] : [3, 2]) : [2];
					case 1:
						B = A.sent(), A.label = 2;
					case 2:
						return De.getInstance(this.id).debug("Added image " + s.substring(0, 256)), [4, new Promise(function(A, e) {
							...
							t.onload = function() {
									return A(t)
								}, t.onerror = e, (We(B) || r) && (t.crossOrigin = "anonymous"), t.src = B, !0 === t.complete &&
								setTimeout(function() {
									return A(t)
		...
		return new Promise(function(e, t) {
			...
			if (B.onload = function() {
				...
				}, B.onerror = t, B.open("GET", o + "?url=" + encodeURIComponent(n) + "&responseType=" + r), "text" != r && B instanceof XMLHttpRequest &&
				(B.responseType = r), s._options.imageTimeout) {
	...
	(Ve = xe || (xe = {}))[Ve.URL = 0] = "URL", Ve[Ve.LINEAR_GRADIENT = 1] = "LINEAR_GRADIENT", Ve[Ve.RADIAL_GRADIENT = 2] =
		"RADIAL_GRADIENT";
	var rt, Bt, nt, st;
	(Bt = rt || (rt = {}))[Bt.CIRCLE = 0] = "CIRCLE", Bt[Bt.ELLIPSE = 1] = "ELLIPSE", (st = nt || (nt = {}))[st.CLOSEST_SIDE =
	...
	(St = Dt || (Dt = {}))[St.NONE = 0] = "NONE", St[St.LEFT = 1] = "LEFT", St[St.RIGHT = 2] = "RIGHT", St[St.INLINE_START =
		3] = "INLINE_START";
	var kt, Wt, Yt, qt, Zt = {
			name: "float",
			initialValue: "none",
	...
	var tB = {
			...
			parse: function(A) {
				return 1 === A.length && JA(A[0], "none") ? [] : WA(A).map(function(A) {
					for (var e = {
						...
						var B = A[r];
						JA(B, "inset") ? e.inset = !0 : YA(B) ? (0 === t ? e.offsetX = B : 1 === t ? e.offsetY = B : 2 === t ? e.blur =
							B : e.spread = B, t++) : e.color = we(B)
					}
					return e
				})
			}
		...
		iB = (aB.prototype.isVisible = function() {
			...
			return AB(this.display, 4) || AB(this.display, 33554432) || AB(this.display, 268435456) || AB(this.display,
				536870912) || AB(this.display, 67108864) || AB(this.display, 134217728)
		}, aB);

	function aB(A) {
		this.backgroundClip = uB(me, A.backgroundClip), this.backgroundColor = uB(Re, A.backgroundColor), this.backgroundImage =
			uB(Qt, A.backgroundImage), this.backgroundOrigin = uB(wt, A.backgroundOrigin), this.backgroundPosition = uB(ut, A.backgroundPosition),
			this.backgroundRepeat = uB(Ct, A.backgroundRepeat), this.backgroundSize = uB(dt, A.backgroundSize), this.borderTopColor =
			uB(pt, A.borderTopColor), this.borderRightColor = uB(Nt, A.borderRightColor), this.borderBottomColor = uB(Kt, A.borderBottomColor),
			this.borderLeftColor = uB(It, A.borderLeftColor), this.borderTopLeftRadius = uB(Tt, A.borderTopLeftRadius), this.borderTopRightRadius =
			uB(mt, A.borderTopRightRadius), this.borderBottomRightRadius = uB(Rt, A.borderBottomRightRadius), this.borderBottomLeftRadius =
			uB(Lt, A.borderBottomLeftRadius), this.borderTopStyle = uB(bt, A.borderTopStyle), this.borderRightStyle = uB(Mt, A.borderRightStyle),
			this.borderBottomStyle = uB(yt, A.borderBottomStyle), this.borderLeftStyle = uB(_t, A.borderLeftStyle), this.borderTopWidth =
			uB(Pt, A.borderTopWidth), this.borderRightWidth = uB(xt, A.borderRightWidth), this.borderBottomWidth = uB(Vt, A.borderBottomWidth),
			this.borderLeftWidth = uB(zt, A.borderLeftWidth), this.boxShadow = uB(oB, A.boxShadow), this.color = uB(Xt, A.color),
			this.display = uB(Jt, A.display), this.float = uB(Zt, A.cssFloat), this.fontFamily = uB(Yr, A.fontFamily), this.fontSize =
			uB(Zr, A.fontSize), this.fontStyle = uB(tB, A.fontStyle), this.fontVariant = uB($r, A.fontVariant), this.fontWeight =
			uB(jr, A.fontWeight), this.letterSpacing = uB(jt, A.letterSpacing), this.lineBreak = uB($t, A.lineBreak), this.lineHeight =
			uB(Ar, A.lineHeight), this.listStyleImage = uB(er, A.listStyleImage), this.listStylePosition = uB(Br, A.listStylePosition),
			this.listStyleType = uB(ir, A.listStyleType), this.marginTop = uB(ar, A.marginTop), this.marginRight = uB(cr, A.marginRight),
			this.marginBottom = uB(Qr, A.marginBottom), this.marginLeft = uB(wr, A.marginLeft), this.opacity = uB(Gr, A.opacity);
		var e = uB(Er, A.overflow);
		this.overflowX = e[0], this.overflowY = e[1 < e.length ? 1 : 0], this.overflowWrap = uB(Fr, A.overflowWrap), this.paddingTop =
			uB(hr, A.paddingTop), this.paddingRight = uB(Hr, A.paddingRight), this.paddingBottom = uB(dr, A.paddingBottom),
			this.paddingLeft = uB(fr, A.paddingLeft), this.position = uB(mr, A.position), this.textAlign = uB(Kr, A.textAlign),
			this.textDecorationColor = uB(kr, A.textDecorationColor || A.color), this.textDecorationLine = uB(Wr, A.textDecorationLine),
			this.textShadow = uB(Rr, A.textShadow), this.textTransform = uB(vr, A.textTransform), this.transform = uB(Dr, A.transform),
			this.transformOrigin = uB(yr, A.transformOrigin), this.visibility = uB(xr, A.visibility), this.wordBreak = uB(Xr, A
				.wordBreak), this.zIndex = uB(Jr, A.zIndex)
	}
	var cB, QB = function(A) {
		...
		UB = function(A) {
			this.styles = new iB(window.getComputedStyle(A, null)), this.textNodes = [], this.elements = [], null !== this.styles
				.transform && un(A) && (A.style.transform = "none"), this.bounds = T(A), this.flags = 0
		},
		lB = function(A, e) {
	...
	function NB(A) {
		...
		return e.src = A.currentSrc || A.src, e.intrinsicWidth = A.naturalWidth, e.intrinsicHeight = A.naturalHeight, be.getInstance()
			.addImage(e.src), e
	}
	...
	function LB(A) {
		...
		return e.svg = "data:image/svg+xml," + encodeURIComponent(t.serializeToString(A)), e.intrinsicWidth = A.width.baseVal
			.value, e.intrinsicHeight = A.height.baseVal.value, be.getInstance().addImage(e.svg), e
	}
	...
	function GB(A) {
		...
		switch (e.type = A.type.toLowerCase(), e.checked = A.checked, e.value = function(A) {
			var e = A.type === zB ? new Array(A.value.length + 1).join("â€¢") : A.value;
			return 0 === e.length ? A.placeholder || "" : e
		}(A), e.type !== xB && e.type !== VB || (e.styles.backgroundColor = 3739148031, e.styles.borderTopColor = e.styles.borderRightColor =
	...
	function tn(A) {
		...
		try {
			if (A.contentWindow && A.contentWindow.document && A.contentWindow.document.documentElement) {
				...
				var t = A.contentWindow.document.documentElement ? $B(getComputedStyle(A.contentWindow.document.documentElement).backgroundColor) :
					He.TRANSPARENT,
	...
	var Bn = ["OL", "UL", "MENU"],
		nn = function(A, e, t) {
			for (var r = A.firstChild, B = void 0; r; r = B)
				...
				var n = sn(r);
				n.styles.isVisible() && (an(r, n, t) ? n.flags |= 4 : cn(n.styles) && (n.flags |= 2), -1 !== Bn.indexOf(r.tagName) &&
					(n.flags |= 8), e.elements.push(n), dn(r) || gn(r) || fn(r) || nn(r, n, t))
			}
		},
		sn = function(A) {
			return hn(A) ? new pB(A) : Fn(A) ? new IB(A) : gn(A) ? new RB(A) : Un(A) ? new vB(A) : ln(A) ? new bB(A) : Cn(A) ?
				new JB(A) : fn(A) ? new WB(A) : dn(A) ? new ZB(A) : Hn(A) ? new en(A) : new UB(A)
		},
		on = function(A) {
			var e = sn(A);
	...
	function Rn(A, e, t, r, B, n) {
		...
		for (var i = 0; 0 < s && i <= 4; i++) {
			var a = s % 10;
			0 == a && AB(n, 1) && "" !== o ? o = e[a] + o : 1 < a || 1 == a && 0 === i || 1 == a && 1 === i && AB(n, 2) || 1 ==
				a && 1 === i && AB(n, 4) && 100 < A || 1 == a && 1 < i && AB(n, 8) ? o = e[a] + (0 < i ? t[i - 1] : "") + o : 1 ==
	...
	var Ln, On, vn = {
		...
		Dn = {
			...
			values: ["Õ”", "Õ“", "Õ’", "Õ‘", "Õ", "Õ", "ÕŽ", "Õ", "ÕŒ", "Õ‹", "ÕŠ", "Õ‰", "Õˆ", "Õ‡", "Õ†", "Õ…", "Õ„", "Õƒ",
				"Õ‚", "Õ", "Õ€", "Ô¿", "Ô¾", "Ô½", "Ô¼", "Ô»", "Ôº", "Ô¹", "Ô¸", "Ô·", "Ô¶", "Ôµ", "Ô´", "Ô³", "Ô²", "Ô±"
			]
		},
		Sn = {
		...
		bn = {
			...
			values: ["áƒµ", "áƒ°", "áƒ¯", "áƒ´", "áƒ®", "áƒ­", "áƒ¬", "áƒ«", "áƒª", "áƒ©", "áƒ¨", "áƒ§", "áƒ¦", "áƒ¥", "áƒ¤",
				"áƒ³", "áƒ¢", "áƒ¡", "áƒ ", "áƒŸ", "áƒž", "áƒ", "áƒ²", "áƒœ", "áƒ›", "áƒš", "áƒ™", "áƒ˜", "áƒ—", "áƒ±", "áƒ–",
				"áƒ•", "áƒ”", "áƒ“", "áƒ’", "áƒ‘", "áƒ"
			]
		},
		Mn = "ë§ˆì´ë„ˆìŠ¤",
		yn = function(A, e, t) {
			...
			switch (e) {
				...
				case tr.CJK_DECIMAL:
					return mn(A, "ã€‡ä¸€äºŒä¸‰å››äº”å…­ä¸ƒå…«ä¹", B);
				case tr.LOWER_ROMAN:
				...
				case tr.CJK_EARTHLY_BRANCH:
					return mn(A, "å­ä¸‘å¯…å¯è¾°å·³åˆæœªç”³é…‰æˆŒäº¥", B);
				case tr.CJK_HEAVENLY_STEM:
					return mn(A, "ç”²ä¹™ä¸™ä¸æˆŠå·±åºšè¾›å£¬ç™¸", B);
				case tr.CJK_IDEOGRAPHIC:
				case tr.TRAD_CHINESE_INFORMAL:
					return Rn(A, "é›¶ä¸€äºŒä¸‰å››äº”å…­ä¸ƒå…«ä¹", "åç™¾åƒè¬", "è² ", B, 14);
				case tr.TRAD_CHINESE_FORMAL:
					return Rn(A, "é›¶å£¹è²³åƒè‚†ä¼é™¸æŸ’æŒçŽ–", "æ‹¾ä½°ä»Ÿè¬", "è² ", B, 15);
				case tr.SIMP_CHINESE_INFORMAL:
					return Rn(A, "é›¶ä¸€äºŒä¸‰å››äº”å…­ä¸ƒå…«ä¹", "åç™¾åƒè¬", "è´Ÿ", B, 14);
				case tr.SIMP_CHINESE_FORMAL:
					return Rn(A, "é›¶å£¹è´°åè‚†ä¼é™†æŸ’æŒçŽ–", "æ‹¾ä½°ä»Ÿè¬", "è´Ÿ", B, 15);
				case tr.JAPANESE_INFORMAL:
					return Rn(A, "ã€‡ä¸€äºŒä¸‰å››äº”å…­ä¸ƒå…«ä¹", "åç™¾åƒä¸‡", "ãƒžã‚¤ãƒŠã‚¹", B, 0);
				case tr.JAPANESE_FORMAL:
					return Rn(A, "é›¶å£±å¼å‚å››ä¼å…­ä¸ƒå…«ä¹", "æ‹¾ç™¾åƒä¸‡", "ãƒžã‚¤ãƒŠã‚¹", B, 7);
				case tr.KOREAN_HANGUL_FORMAL:
					return Rn(A, "ì˜ì¼ì´ì‚¼ì‚¬ì˜¤ìœ¡ì¹ íŒ”êµ¬", "ì‹­ë°±ì²œë§Œ", Mn, n, 7);
				case tr.KOREAN_HANJA_INFORMAL:
					return Rn(A, "é›¶ä¸€äºŒä¸‰å››äº”å…­ä¸ƒå…«ä¹", "åç™¾åƒè¬", Mn, n, 0);
				case tr.KOREAN_HANJA_FORMAL:
					return Rn(A, "é›¶å£¹è²³åƒå››äº”å…­ä¸ƒå…«ä¹", "æ‹¾ç™¾åƒ", Mn, n, 7);
				case tr.DEVANAGARI:
		...
		Pn = (xn.prototype.toIFrame = function(A, e) {
			...
			var B = A.defaultView.pageXOffset,
				...
				i = Jn(r).then(function() {
					t.scrolledElements.forEach(Yn), s && (s.scrollTo(e.left, e.top), !/(iPad|iPhone|iPod)/g.test(navigator.userAgent) ||
						s.scrollY === e.top && s.scrollX === e.left || (o.documentElement.style.top = -e.top + "px", o.documentElement
							.style.left = -e.left + "px", o.documentElement.style.position = "absolute"));
					var A = t.options.onclone;
					return void 0 === t.clonedReferenceElement ? Promise.reject("Error finding the " + t.referenceElement.nodeName +
						" in the cloned document") : "function" == typeof A ? Promise.resolve().then(function() {
						return A(o)
					}).then(function() {
						return r
					}) : r
				});
			return o.open(), o.write(kn(document.doctype) + "<html></html>"), Wn(this.referenceElement.ownerDocument, B, n), o
			...
			if (un(A) && e) {
				...
				for (var s = this.counters.parse(new wB(r)), o = this.resolvePseudoContent(A, t, B, Ln.BEFORE), i = A.firstChild; i; i =
					i.nextSibling) wn(i) && ("SCRIPT" === i.tagName || i.hasAttribute(_n) || "function" == typeof this.options.ignoreElements &&
					this.options.ignoreElements(i)) || this.options.copyStyles && wn(i) && rn(i) || t.appendChild(this.cloneNode(i));
				o && t.insertBefore(o, t.firstChild);
				var a = this.resolvePseudoContent(A, t, n, Ln.AFTER);
				return a && t.appendChild(a), this.counters.pop(s), r && this.options.copyStyles && !Hn(A) && Gn(r, t), 0 === A.scrollTop &&
					0 === A.scrollLeft || this.scrolledElements.push([t, A.scrollLeft, A.scrollTop]), (dn(A) || fn(A)) && (dn(t) ||
						fn(t)) && (t.value = A.value), t
			}
			return A.cloneNode(!1)
	...
	function xn(A, e) {
		if (this.options = e, this.scrolledElements = [], this.referenceElement = A, this.counters = new pn, this.quoteDepth =
	...
	var Vn, zn, Xn = function(A, e) {
			...
			return t.className = "html2canvas-container", t.style.visibility = "hidden", t.style.position = "fixed", t.style.left =
				...
				t.scrolling = "no", t.setAttribute(_n, "true"), A.body.appendChild(t), t
		},
		Jn = function(B) {
	...
	var is, as, cs = function(A) {
		...
		this.topLeftBorderBox = 0 < B || 0 < n ? us(t.left, t.top, B, n, is.TOP_LEFT) : new ts(t.left, t.top), this.topRightBorderBox =
			...
			this.bottomLeftBorderBox = 0 < u || 0 < U ? us(t.left, t.top + h, u, U, is.BOTTOM_LEFT) : new ts(t.left, t.top + t
				.height), this.topLeftPaddingBox = 0 < B || 0 < n ? us(t.left + p, t.top + H, Math.max(0, B - p), Math.max(0, n -
			...
			0 < u || 0 < U ? us(t.left + p, t.top + h, Math.max(0, u - p), U - f, is.BOTTOM_LEFT) : new ts(t.left + p, t.top +
				t.height - f), this.topLeftContentBox = 0 < B || 0 < n ? us(t.left + p + T, t.top + H + N, Math.max(0, B - (p + T)),
				Math.max(0, n - (H + N)), is.TOP_LEFT) : new ts(t.left + p + T, t.top + H + N), this.topRightContentBox = 0 < o ||
	...
	function hs(A) {
		...
		return t.add(r + e.borderLeftWidth, n + e.borderTopWidth, -(e.borderRightWidth + e.borderLeftWidth + r + B), -(e.borderTopWidth +
			e.borderBottomWidth + n + s))
	}
	...
	var ps = function(c, Q, w, u) {
		...
		Ns = function(A, e) {
			for (var t = A instanceof bB ? A.start : 1, r = A instanceof bB && A.reversed, B = 0; B < e.length; B++) {
				...
				n.container instanceof vB && "number" == typeof n.container.value && 0 !== n.container.value && (t = n.container.value),
					n.listValue = yn(t, n.container.styles.listStyleType, !0), t += r ? -1 : 1
			}
		},
		Ks = function(A, e, t, r) {
			var B = [];
			return os(A) ? B.push(A.subdivide(.5, !1)) : B.push(A), os(t) ? B.push(t.subdivide(.5, !0)) : B.push(t), os(r) ? B.push(
				r.subdivide(.5, !0).reverse()) : B.push(r), os(e) ? B.push(e.subdivide(.5, !1).reverse()) : B.push(e), B
		},
		Is = function(A, e, t) {
			var r = e[0],
				B = e[1],
			...
			var i = fs(n);
			if (zA(s) && (s.value === Ut.CONTAIN || s.value === Ut.COVER)) return fs(n) ? t.width / t.height < n != (s.value ===
				Ut.COVER) ? [t.width, t.width / n] : [t.height * n, t.height] : [t.width, t.height];
			var a = fs(r),
				c = fs(B),
				Q = a || c;
			if (ds(s) && (!o || ds(o))) return a && c ? [r, B] : i || Q ? Q && i ? [a ? r : B * n, c ? B : r / n] : [a ? r : t.width,
				c ? B : t.height
			] : [t.width, t.height];
			if (i) {
				var w = 0,
					u = 0;
				return qA(s) ? w = ae(s, t.width) : qA(o) && (u = ae(o, t.height)), ds(s) ? w = u * n : o && !ds(o) || (u = w / n),
					[w, u]
			}
			var U = null,
				l = null;
			if (qA(s) ? U = ae(s, t.width) : o && qA(o) && (l = ae(o, t.height)), null === U || o && !ds(o) || (l = a && c ? U /
					r * B : t.height), null !== l && ds(s) && (U = a && c ? l / B * r : t.width), null !== U && null !== l) return [U,
				l
			];
			...
			switch (A) {
				case it.REPEAT_X:
					return [new ts(Math.round(r.left), Math.round(r.top + s)), new ts(Math.round(r.left + r.width), Math.round(r.top +
						...
						r.top + s))];
				case it.REPEAT_Y:
					return [new ts(Math.round(r.left + n), Math.round(r.top)), new ts(Math.round(r.left + n + o), Math.round(r.top)),
						new ts(Math.round(r.left + n + o), Math.round(r.height + r.top)), new ts(Math.round(r.left + n), Math.round(r.height +
							r.top))
					];
				case it.NO_REPEAT:
					return [new ts(Math.round(r.left + n), Math.round(r.top + s)), new ts(Math.round(r.left + n + o), Math.round(r.top +
						s)), new ts(Math.round(r.left + n + o), Math.round(r.top + s + i)), new ts(Math.round(r.left + n), Math.round(
						r.top + s + i))];
				default:
					return [new ts(Math.round(B.left), Math.round(B.top)), new ts(Math.round(B.left + B.width), Math.round(B.top)),
						new ts(Math.round(B.left + B.width), Math.round(B.height + B.top)), new ts(Math.round(B.left), Math.round(B.height +
							B.top))
					]
			}
		},
		...
		Ls = (Os.prototype.parseMetrics = function(A, e) {
			...
			t.style.visibility = "hidden", t.style.fontFamily = A, t.style.fontSize = e, t.style.margin = "0", t.style.padding =
				"0", n.appendChild(t), r.src = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7",
				r.width = 1, r.height = 1, r.style.margin = "0", r.style.padding = "0", r.style.verticalAlign = "baseline", B.style
				.fontFamily = A, B.style.fontSize = e, B.style.margin = "0", B.style.padding = "0", B.appendChild(this._document.createTextNode(
					Rs)), t.appendChild(B), t.appendChild(r);
			var s = r.offsetTop - B.offsetTop + 2;
			t.removeChild(B), t.appendChild(this._document.createTextNode(Rs)), t.style.lineHeight = "normal", r.style.verticalAlign =
				"super";
	...
	var vs = (Ds.prototype.applyEffects = function(A, e) {
		...
		return B(this, void 0, void 0, function() {
			var e, t, B, n, s = this;
			return b(this, function(A) {
				return e = this.createFontStyle(o), t = e[0], B = e[1], n = e[2], this.ctx.font = t, r.textBounds.forEach(
					function(r) {
		...
		if (t && 0 < A.intrinsicWidth && 0 < A.intrinsicHeight) {
			var r = hs(A),
				B = ws(e);
			this.path(B), this.ctx.save(), this.ctx.clip(), this.ctx.drawImage(t, 0, 0, A.intrinsicWidth, A.intrinsicHeight,
		...
		return B(this, void 0, void 0, function() {
			...
			return b(this, function(A) {
				switch (A.label) {
					case 0:
						this.applyEffects(l.effects, 4), e = l.container, t = l.curves, r = e.styles, B = 0, n = e.textNodes, A.label =
							1;
					case 1:
					...
					case 14:
						if (e instanceof JB && (i = Math.min(e.bounds.width, e.bounds.height), e.type === xB ? e.checked && (this.ctx
								...
								]), this.ctx.fillStyle = te(XB), this.ctx.fill(), this.ctx.restore()) : e.type === VB && e.checked && (
								this.ctx.save(), this.ctx.beginPath(), this.ctx.arc(e.bounds.left + i / 2, e.bounds.top + i / 2, i / 4,
									0, 2 * Math.PI, !0), this.ctx.fillStyle = te(XB), this.ctx.fill(), this.ctx.restore())), Ss(e) && e.value
							.length) {
							...
							c = U.add(a, 0, 0, -U.height / 2 + 1), this.ctx.save(), this.path([new ts(U.left, U.top), new ts(U.left +
								...
								.clip(), this.renderTextWithLetterSpacing(new lB(e.value, c), r.letterSpacing), this.ctx.restore(), this
							...
							.fillStyle = te(r.color), this.ctx.textBaseline = "middle", this.ctx.textAlign = "right", U = new I(e.bounds
								...
								function(A, e) {
									return zA(A) && "normal" === A.value ? 1.2 * e : A.type === sA.NUMBER_TOKEN ? e * A.number : qA(A) ?
										ae(A, e) : e
								}(r.lineHeight, r.fontSize.number) / 2 + 1), this.renderTextWithLetterSpacing(new lB(l.listValue, U), r
						...
						v = S.styles.backgroundImage.length - 1, e = function(e) {
							...
							return b(this, function(A) {
								switch (A.label) {
									...
									case 4:
										return t && (B = Hs(S, v, [t.width, t.height, t.width / t.height]), g = B[0], f = B[1], p = B[2], h =
											B[3], H = B[4], l = D.ctx.createPattern(D.resizeImage(t, h, H), "repeat"), D.renderRepeat(g, l, f,
												p)), [3, 6];
									case 5:
										! function(A) {
										...
										}(e) && (C = Hs(S, v, [null, null, null]), g = C[0], E = C[1], F = C[2], h = C[3], H = C[4], d = 0 ===
											e.position.length ? [oe] : e.position, f = ae(d[0], h), p = ae(d[d.length - 1], H), N = function(A,
												...
												switch (A.size) {
													case nt.CLOSEST_SIDE:
														A.shape === rt.CIRCLE ? n = s = Math.min(Math.abs(e), Math.abs(e - r), Math.abs(t), Math.abs(t -
															B)) : A.shape === rt.ELLIPSE && (n = Math.min(Math.abs(e), Math.abs(e - r)), s = Math.min(
															Math.abs(t), Math.abs(t - B)));
														break;
													case nt.CLOSEST_CORNER:
														if (A.shape === rt.CIRCLE) n = s = Math.min(Ne(e, t), Ne(e, t - B), Ne(e - r, t), Ne(e - r, t -
															B));
													...
													case nt.FARTHEST_SIDE:
														A.shape === rt.CIRCLE ? n = s = Math.max(Math.abs(e), Math.abs(e - r), Math.abs(t), Math.abs(t -
															B)) : A.shape === rt.ELLIPSE && (n = Math.max(Math.abs(e), Math.abs(e - r)), s = Math.max(
															Math.abs(t), Math.abs(t - B)));
														break;
													case nt.FARTHEST_CORNER:
														if (A.shape === rt.CIRCLE) n = s = Math.max(Ne(e, t), Ne(e, t - B), Ne(e - r, t), Ne(e - r, t -
															B));
														else if (A.shape === rt.ELLIPSE) {
												...
												return Array.isArray(A.size) && (n = ae(A.size[0], r), s = 2 === A.size.length ? ae(A.size[1], B) :
													n), [n, s]
											...
											}), D.path(g), D.ctx.fillStyle = T, K !== I ? (m = S.bounds.left + .5 * S.bounds.width, R = S.bounds
												.top + .5 * S.bounds.height, O = 1 / (L = I / K), D.ctx.save(), D.ctx.translate(m, R), D.ctx.transform(
													1, 0, 0, L, 0, 0), D.ctx.translate(-m, -R), D.ctx.fillRect(E, O * (F - R) + R, h, H * O), D.ctx
												.restore()) : D.ctx.fill())) : (n = Hs(S, v, [null, null, null]), g = n[0], f = n[1], p = n[2], h =
											n[3], H = n[4], s = pe(e.angle, h, H), o = s[0], i = s[1], a = s[2], c = s[3], Q = s[4], (w =
				...
				switch (A.label) {
					case 0:
						return this.applyEffects(c.effects, 2), e = c.container.styles, t = !ee(e.backgroundColor) || e.backgroundImage
							...
							}], B = bs(Ts(e.backgroundClip, 0), c.curves), t || e.boxShadow.length ? (this.ctx.save(), this.path(B),
	...
	function Ds(A) {
		this._activeEffects = [], this.canvas = A.canvas ? A.canvas : document.createElement("canvas"), this.ctx = this.canvas
			.getContext("2d"), this.options = A, this.canvas.width = Math.floor(A.width * A.scale), this.canvas.height = Math.floor(
				A.height * A.scale), this.canvas.style.width = A.width + "px", this.canvas.style.height = A.height + "px", this.fontMetrics =
			new Ls(document), this.ctx.scale(this.options.scale, this.options.scale), this.ctx.translate(-A.x + A.scrollX, -A.y +
				A.scrollY), this.ctx.textBaseline = "bottom", this._activeEffects = [], De.getInstance(A.id).debug(
				...
				return b(this, function(A) {
					switch (A.label) {
						case 0:
							...
							return r = (Math.round(1e3 * Math.random()) + Date.now()).toString(16), B = En(p) || function(A) {
								...
								var r = Math.max(Math.max(e.scrollWidth, t.scrollWidth), Math.max(e.offsetWidth, t.offsetWidth), Math.max(
									...
									B = Math.max(Math.max(e.scrollHeight, t.scrollHeight), Math.max(e.offsetHeight, t.offsetHeight), Math.max(
								...
								height: Math.ceil(s),
								id: r
							}, Q = K({}, c, a, N), w = new I(Q.scrollX, Q.scrollY, Q.windowWidth, Q.windowHeight), De.create(r), De.getInstance(
								r).debug("Starting document clone"), u = new Pn(p, {
								id: r,
								onclone: Q.onclone,
						...
						case 2:
							return d = A.sent(), [3, 5];
						case 3:
							return De.getInstance(r).debug("Document cloned, using computed rendering"), be.attachInstance(Q.cache), De
								.getInstance(r).debug("Starting DOM parsing"), f = on(U), be.detachInstance(), h === f.styles.backgroundColor &&
								(f.styles.backgroundColor = He.TRANSPARENT), De.getInstance(r).debug("Starting renderer"), [4, new vs(H).render(
									f)];
						case 4:
							d = A.sent(), A.label = 5;
						case 5:
							return !0 === Q.removeContainer && (zs(l) || De.getInstance(r).error(
								"Cannot detach cloned iframe as it is not in the DOM anymore")), De.getInstance(r).debug(
								"Finished rendering"), De.destroy(r), be.destroy(r), [2, d]
					}
				})
			})
		},
